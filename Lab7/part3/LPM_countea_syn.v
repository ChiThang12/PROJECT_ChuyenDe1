...
//lpm_counter DEVICE_FAMILY="Cyclone II" lpm_port_updown="PORT_USED" lpm_width=16 clk_en clock cnt_en q sclr updown
...
module LPM_countea (
	...
	LPM_countea_cntr	LPM_countea_cntr_component (
				.clk_en (clk_en),
				.clock (clock),
				.sclr (sclr),
				.cnt_en (cnt_en),
